...
<div class="container">
    ...
    <header class="jumbotron my-4">
        <h1 class="display-4">Welcome to SudokuMAX!</h1>
        <p class="lead">Best online interactive Sudoku game!!!</p>
        <?php
        if ( isset( $_SESSION['user_id'] ) ) {
            echo '<a href="dashboard.php" class="btn btn-primary btn-lg">Go To Dashboard!</a>';
        }
        else {
            echo '<a href="register.php" class="btn btn-primary btn-lg">Register Now!</a>';
        }
        ?>
    </header>
